...
<?php
    ...
    // Captura dos dados com filtro de segurança
        ...
        $informativos = filter_input(INPUT_POST, 'informativos',
        FILTER_SANITIZE_SPECIAL_CHARS);

    // Operador de coalescência nula (Verifica se o que está a esquerda existe
    // (interesses), senão pega o da direita, neste caso vazio [])
